...
<html lang="en" class="h-100">
    <head>
        ...
        <title>Beyond beauty - error</title>
    </head>
    ...
    <body class="d-flex h-100 text-center text-white bg-dark">
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main class="px-3">
                <h1>Oh no, something went wrong UwU</h1>
                <p class="lead">
                    Our team is probably trying to fix it right now, meanwhile we suggest going back to the
